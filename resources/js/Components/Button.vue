...
export default {
    ...
    setup(props, { emit }) {
        ...
        const variantClasses = (variant) => ({
            'bg-red-500 text-white hover:bg-red-600 focus:ring-red-400': variant == 'primary',
            'bg-white text-gray-500 hover:bg-gray-100 focus:ring-red-500 dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200':
                variant == 'secondary',
