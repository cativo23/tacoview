<template>
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <nav class="flex flex-wrap justify-center -mx-5 -my-2">
            <div class="px-5 py-2">
                <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900">Sobre Nosotros</a>
            </div>
            <div class="px-5 py-2">
            ...
            <div class="px-5 py-2">
                <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900">Contacto</a>
            </div>
            <div class="px-5 py-2">
                <Link :href="route('terms.show')" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                    Terms
                </Link>
            </div>
        </nav>
        ...
        <p class="mt-8 text-base leading-6 text-center text-gray-400">© 2022 tacoview. All rights reserved.</p>
    </div>
</template>
